...
`OPL ScholarSkills` is an OPL-owned capability library, not an additional
brand module and not a domain truth owner. Its docs stay compact: module
contracts and gallery review surfaces are current support docs; generated or
domain-owned artifacts remain with their owning runtime or domain repo.
